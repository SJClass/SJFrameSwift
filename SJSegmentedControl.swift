//
//  SJSegmentedControl.swift
//  Pods
//
//  Created by Arun SJ on 05/03/19.
//
...
@IBDesignable
open class SJSegmentedControl: UIView {
    
    //Configure the options to for a custom design
    @IBInspectable open var defaultTextFont: UIFont = UIFont.systemFont(ofSize: 12)// UIFont.helveticaNeueLight(12)
    @IBInspectable open var selectedTextFont: UIFont = UIFont.systemFont(ofSize: 12)//UIFont.helveticaNeueLight(12)
    ...
    @IBInspectable open var containerBackgroundColor: UIColor = UIColor(rgb: 0xF4F4F4)// SJSegmentedControl.UIColorFromRGB(0xF4F4F4)
    @IBInspectable open var thumbColor: UIColor = UIColor.clear
    @IBInspectable open var thumbGradientColors: [UIColor]? = [UIColor(rgb: 0xFFDE82)/*TTSegmentedControl.UIColorFromRGB(0xFFE900)*/,UIColor(rgb: 0xFFDE82)/*TTSegmentedControl.UIColorFromRGB(0xFFB400)*/]
    @IBInspectable open var thumbShadowColor: UIColor = UIColor(rgb: 0x9B9B9B);// TTSegmentedControl.UIColorFromRGB(0x9B9B9B)
    ...
    open var itemTitles: [String] = [SJLocalisedString["key_Dashboard_Aviation_forecast"], SJLocalisedString["key_Dashboard_Marine_forecast"]]
